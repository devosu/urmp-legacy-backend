...
// import {
//   deleteBatchUsersController,
//   readAllUsersController,
//   readBatchUsersController,
//   updateBatchUsersController,
// } from "@controllers/v0/v0BatchUserController";
import {
...
export default function v0UsersRouter(): Router {
  ...
  router.post(
    "/",
    [v0MockAuthenticator /* v0SchemaValidator, */],
  ...
  // router.put(
  //   "/batch",
  //   [ v0MockAuthenticator, /* v0SchemaArrayValidator, */ ],
  //   (req: Request, res: Response, next: NextFunction):void => {
  //     updateBatchUsersController(req, res, next);
  //   },
  // );

  // // Handles DELETE request to DELETE batch users by query parameters.
  // router.delete(
  //   "/batch",
  //   [ v0MockAuthenticator, /* v0SchemaArrayValidator, */ ],
  //   (req: Request, res: Response, next: NextFunction):void => {
  //     deleteBatchUsersController(req, res, next);
  //   },
  // );
