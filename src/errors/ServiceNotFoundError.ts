...
/**
 * Error for when a requested service is not found, extending JavaScript's Error class.
...
export default class ServiceNotFoundError extends Error {
  ...
  /**
   * Constructs a new `ServiceNotFoundError` instance with a custom message and optional details.
   *
