// ./src/mocks/v0/mockApprovedMentors.ts
//
// Deterministic mock data for approved mentors.
...
export const sampleMockApprovedMentor: MentorSchema = {
  ...
  calendarSchedulingLink    : "http://dummyimage.com/177x205.png/5fa2dd/ffffff",
};

// Array of mock approved mentor users.
export const mockApprovedMentorsArray: MentorSchema[] = [
  sampleMockApprovedMentor,
  {
    ...
    profilePictureLink: "http://dummyimage.com/248x200.png/ff4444/ffffff",
  ...
  },
  {
    ...
    firstName           : "Griffin",
    lastName            : "Jindracek",
    proficientLanguages : ["English - English", "Spanish - Español"],
