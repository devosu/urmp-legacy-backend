...
import type { NewSignupSchema, } from "@src/models/v0/v0UserModel.js";

// Deterministic sample mock mixed pending approval AND approved NewSignup document.
export const sampleMockNewSignup: NewSignupSchema = {
  // Generic info.
...
export const mockNewSignupsArray: NewSignupSchema[] = [
  sampleMockNewSignup,
  {
    // Generic info.
